...
const char HTTP_STYLE[] PROGMEM = "<style>"
								  ...
								  "button,input[type='button'],input[type='submit']{cursor:pointer;border:0;background-color:#ecb51f;color:#fff;line-height:2.4rem;font-size:1.2rem;width:100%}"
								  "input[type='file']{border:1px solid #ecb51f}"
								  ".wrap {text-align:left;display:inline-block;min-width:260px;max-width:500px}"
								  // links
								  "a{color:#000;font-weight:700;text-decoration:none}a:hover{color:#ecb51f;text-decoration:underline}"
								  // quality icons
								  ...
								  // msg callouts
								  ".msg{padding:20px;margin:20px 0;border:1px solid #eee;border-left-width:5px;border-left-color:#777}.msg h4{margin-top:0;margin-bottom:5px}.msg.P{border-left-color:#ecb51f}.msg.P h4{color:#ecb51f}.msg.D{border-left-color:#dc3630}.msg.D h4{color:#dc3630}.msg.S{border-left-color: #5cb85c}.msg.S h4{color: #5cb85c}"
								  // lists
